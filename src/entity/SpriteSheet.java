...
public class SpriteSheet {
	...
	public BufferedImage nextFrame(String direction) 
	{
		...
		if(directions.contains(direction)) {
			...
			//For Testing
			curImage = GUtil.scaleImage(sheet.getSubimage(ctrX*frameWidth, 0, frameWidth, frameHeight), 48, 48);
			return curImage;
		}
		return null;
	}
	...
	public BufferedImage displayStanding(String direction) 
	{
		...
		//For Testing
		curImage = GUtil.scaleImage(sheet.getSubimage(0, 0, frameWidth, frameHeight), 48, 48);
		return curImage;
	}
}
