...
public class Player extends Entity{
	...
	public Player(GamePanel gp, KeyHandler keyH) 
	{
		...
		tempDirections.add("upright");
		tempDirections.add("upleft");
		tempDirections.add("downright");
		tempDirections.add("downleft");
	...
	public void update() 
	{
		...
		{	
			...
			System.out.println();
			System.out.println("At Time: "+ (keyH.timeCtr/(Math.pow(10, 9))));
			System.out.println("UpPressed is: "+keyH.upPressed);
			System.out.println("DownPressed is: "+keyH.downPressed);
			System.out.println("LeftPressed is: "+keyH.leftPressed);
			System.out.println("RightPressed is: "+keyH.rightPressed);
			System.out.println("Thus, Direction is: "+direction);
			System.out.println();
			keyH.timeCtr++;
