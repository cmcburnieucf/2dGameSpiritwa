...
public class Player extends Entity{
	...
	public boolean attackCancelled = false, isStanding = false;
	...
	public void damageEnemy(int index, int attack, int kbPow) 
	{
		if(index != -1) 
		{
			...
			{
				if(kbPow > 0) {
					handleKnockBack(gp.enemies[gp.curMap][index], kbPow);
				}
	...
	public void handleAttack()
	{
		...
		if(spriteCtr > 5 && spriteCtr <= 25) 
		{
			...
			damageEnemy(gp.collisionCheck.checkEntity(this, gp.enemies), attack, curWeapon.kbPower);
	...
	public void handleKnockBack(Entity entity, int kbPow) {
