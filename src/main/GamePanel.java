...
public class GamePanel extends JPanel implements Runnable{
	...
	public final int /*maxWorldCol = 50, maxWorldRow = 50,*/ maxMap = 1;
	...
	public ArrayList<Entity> shotList = new ArrayList<>();
	...
	public void update() 
	{
		if(gameState == playState) {
			...
			for(int i = 0; i < shotList.size(); i++) {
				if(shotList.get(i) != null) 
				{
					if(shotList.get(i).alive)
